...
namespace Everest.Tests
{
	public class RoutingTests
	{
		...
		public void False_FooBar_Slash()
		{
			...
			Assert.False(parser.TryParse(segment, endPoint, out _));
		}
		...
		public void True_Foo_Bar__Foo_Bar()
		{
			...
			Assert.True(parser.TryParse(segment, endPoint, out _));
		}
		...
		public void True_Foo_Bar_IdString__Foo_Bar_1()
		{
			...
			Assert.True(parser.TryParse(segment, endPoint, out var parameters));
